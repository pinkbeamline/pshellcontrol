scan.ge_SEC_EL_continuous_points_speed(19600, 800, 5, -5000, 8000, 1, 500, passes=10, sample='RuMeO NO6')
scan.ge_SEC_EL_continuous_points_speed(-15200, 800, 5, -500, 8000, 1, 500, passes=10, sample='RuMeO NO7')
